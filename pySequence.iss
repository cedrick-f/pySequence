...
OutputBaseFilename=pySequence_1.14
OutputDir=releases
...
[Messages]
BeveledLabel=pySequence 1.14 installation
...
;
Name: {code:DefDesktop}\pySequence 1.14;   Filename: {app}\bin\Sequence.exe; WorkingDir: {app}\bin; MinVersion: 4,4; Tasks: desktopicon2; IconFileName: {app}\bin\Sequence.exe
