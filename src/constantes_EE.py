...
dicIndicateurs_prj = {"CO7.ee1" : [[u"Le besoin relatif au projet est identifié et justifié",True],
...
#
#################################################################################################################################
Fichier_GRILLE = ["Grille_evaluation_STI2D_EE_revues.xlsm", "Grille_evaluation_STI2D_EE_revues.xls"]

Cellules_NON  =  {"CO7.ee1" : [(5,4), (6,4), (7,4), (8,4), (9,4), (10,4), (11,4)],
