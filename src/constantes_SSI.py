...
dicCompetencesSSI =  {"A1" : [u"Analyser le besoin",
                      ...
                      "B4" : [u"Valider un modèle",
                              {"B3.1" : [u"interpréter les résultats obtenus",3],
                               "B3.2" : [u"préciser les limites de validité du modèle utilisé",5],
                               "B3.3" : [u"modifier les paramètres du modèle pour répondre au cahier des charges ou aux résultats expérimentaux",5],
                               "B3.4" : [u"valider un modèle optimisé fourni",5]}],
                      
                      "C1" : [u"Justifier le choix d’un protocole expérimental",
                              {"C1.1" : [u"identifier les grandeurs physiques à mesure",4],
